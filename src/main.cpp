...
uint256 hashGenesisBlock("0x00000000c600ea91f513532b71ff8b8a3cd2432039d3d87a47bc9442e838c829");
...
const string strMessageMagic = "Fusion Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000c600ea91f513532b71ff8b8a3cd2432039d3d87a47bc9442e838c829");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1429957487;
        block.nBits    = 486604799;
        block.nNonce   = 2679276013;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FusionMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FusionMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running FusionMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
